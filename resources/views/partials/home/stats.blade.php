...
<section class="mx-auto w-full max-w-6xl px-6 py-14">
    <div class="grid grid-cols-2 gap-4 lg:grid-cols-4 lg:gap-5">
        ...
        {{-- students --}}
        <div class="reveal glass-panel glass-sheen card-lift theme-t p-4 text-center sm:p-6">
            ...
            <div class="mt-4 text-2xl font-extrabold text-ink sm:text-3xl" style="font-variant-numeric:tabular-nums">
